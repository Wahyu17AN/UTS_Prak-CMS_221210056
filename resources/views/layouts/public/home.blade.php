       ...
       <div class="row gx-5 align-items-center">
           <div class="col-xxl-5">
               ...
               <div class="text-center text-xxl-start">
                   @if(! is_null ($content))
                   <div class="badge bg-gradient-primary-to-secondary text-white mb-4"><div class="text-uppercase">{{ $content->title_1 }}</div></div>
                   ...
                   @else
                       ...
                       <div class="fs-3 fw-light text-muted">Bersama Sistem Informasi</div>
                       <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">Mari Bangun Infrastuktur & Teknologi</span></h1>
                       <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                           <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" href="{{ route ('profile_public') }}">Resume</a>
                           <a class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder" href="{{ route ('project_public') }}">Projects</a>
                       </div>
                   @endif
               </div>
           </div>
